...
#ifndef __EMITTERPLUGINPAGE_H__
#define __EMITTERPLUGINPAGE_H__

/// @file EmitterPluginPage.h
/// @brief UI class to get information for an Emitter plugin
/// @author Callum James
/// @version 1.0
/// @date 24/03/2014
/// Revision History:
/// Initial Version 12/03/2014
/// @class EmitterPluginPage
/// @brief UI class to get information for an Emitter plugin
...
class EmitterPluginPage : public WizardPage
{
    Q_OBJECT
...
public:
    ...
    explicit EmitterPluginPage(int _id, std::string _name, PLUGIN_TYPE _type=NO_PLUGIN_TYPE, MainWindow* _parentWindow = 0, QWidget *_parent = 0);
    /// @brief dtr
    ~EmitterPluginPage();
    ...
    /// @returns PLUGIN_TYPE
    PLUGIN_TYPE defaultType() {return EMITTER;}
