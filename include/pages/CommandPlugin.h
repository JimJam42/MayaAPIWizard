...
#ifndef __COMMANDPLUGIN_H__
#define __COMMANDPLUGIN_H__

/// @file CommandPlugin.h
/// @brief Page to create a command plugin
/// @author Callum James
/// @version 1.0
/// @date 24/03/2014
/// Revision History:
...
/// @class CommandPlugin
/// @brief UI class to get information needed for creating a command plugin
...
class CommandPlugin : public WizardPage
{
    Q_OBJECT
...
public:
    ...
    explicit CommandPlugin(int _id, std::string _name, PLUGIN_TYPE _type=NO_PLUGIN_TYPE, MainWindow* _parentWindow = 0, QWidget *_parent = 0);
    /// @brief dtr
    ~CommandPlugin();
    ...
    /// @returns PLUGIN_TYPE
    PLUGIN_TYPE defaultType() {return CMD;}
...
private:
    /// @brief The UI
    Ui::CommandPlugin *m_ui;

    // attributes to gather information
