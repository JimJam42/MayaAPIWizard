...
#ifndef __INTROPAGE_H__
#define __INTROPAGE_H__

/// @file IntroPage.h
/// @brief UI class to welcome a user to the Wizard
/// @author Callum James
/// @version 1.0
/// @date 24/03/2014
/// Revision History:
...
public:
    ...
    explicit IntroPage(int _id, std::string _name, PLUGIN_TYPE _type=NO_PLUGIN_TYPE, MainWindow* _parentWindow = 0, QWidget *_parent = 0);
    /// @brief dtr
    ~IntroPage();
